...
export const PsychedelicSpiral = forwardRef<HTMLDivElement, PsychedelicSpiralProps>(({
  ...
  spinSpeed = 7.0,
  offset = [0.0, 0.0],
  color1 = '#6094ff',  // Original Balatro red (0.871, 0.267, 0.231)
  color2 = '#152d98',  // Original Balatro blue (0.0, 0.42, 0.706)
  color3 = '#ffffff',  // Original Balatro dark (0.086, 0.137, 0.145)
  contrast = 3.5,
  lighting = 0.4,
  spinAmount = 0.25,
  pixelFilter = 745.0,
